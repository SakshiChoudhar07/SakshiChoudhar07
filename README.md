...
```python
class SakshiChoudhary:

    def __init__(self):
        self.education = "B.Tech CSE (3rd Year)"
        self.college = "Academy of Technology (AOT)"
        ...
        self.motto = "Turning raw data into meaningful insights."
```
...
- ☁️ Future Goal: Data Engineering & Big Data
...
Goal:
  Inspire and learn while creating.
```
